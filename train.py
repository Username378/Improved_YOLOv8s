...
def parse_opt():
    ...
    parser.add_argument('--yaml', type=str, default='ultralytics/models/v8/yolov8s-C2f-Faster-EMA-slimneck.yaml', help='model.yaml path')
    ...
    parser.add_argument('--name', type=str, default='yolov8s-C2f-faster-EMA-slimneck', help='save to project/name')
